...
5. If you need to add another .css file for any reason, you must include it in the `css/generate_css.php` file in the same way the others are. Any time a .css file changes, they are all automatically concatenated, minified, and outputted to `css/generated.css` the first time a page is visited.
